...
Otrzymujesz tę wiadomość, ponieważ osoba znająca Twój adres e-mail zażądała zresetowania hasła do strony <b>mytest.bank</b>. Aby dokonać zmiany hasła, przejdź pod link:<br/>
	...
	Jeżeli nigdy nie podejmowałeś próby zmiany hasła, zignoruj tę wiadomość bądź skontaktuj się z <a href="mailto:joanna.balanda@gmail.com">administratorem</a>.
EOT;
...
if (isset($_POST["email"]) && !empty($_POST["email"])) {
	if (ifExists($_POST["email"], "ggl") == 1) {
		...
		unlink("mail.txt");
		header("location: http://" .$_SERVER["HTTP_HOST"]. "/lista7/lostPass.php");
		exit;
	} else {
